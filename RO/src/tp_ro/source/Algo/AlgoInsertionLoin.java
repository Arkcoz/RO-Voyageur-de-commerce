 ...
 * @author lm178867
 */
public class AlgoInsertionLoin implements Algo{

    private ArrayList<Ville> listeInitiale;
    private ArrayList<Ville> villesNonVisitees;
    private String type;
    
    public AlgoInsertionLoin(ArrayList<Ville> listeVille){
    ...
    public Tour execute() {
        ...
        {
            villeActuelle = Next(villesVisitees, villesNonVisitees);
            villesVisitees = addVille(villeActuelle,villesVisitees);
        }
