 ...
 * @author lm178867
 */
public class AlgoEchangeSuccesseurs_M implements Algo{

    private ArrayList<Ville> listeVille;
    private String type;
    
    public AlgoEchangeSuccesseurs_M(ArrayList<Ville> listeVille){
        this.listeVille = listeVille;
        this.type = "échange de succeseurs (meilleur d'abord)";
    }
