 ...
 * @author lm178867
 */
public class AlgoEchangeSommetsQuelconques_P implements Algo{

    private ArrayList<Ville> listeVille;
    private String type;
    
    public AlgoEchangeSommetsQuelconques_P(ArrayList<Ville> listeVille){
        this.listeVille = listeVille;
        this.type = "échange de sommets quelconques (premier d'abord)";
    }
